...
<header class="sticky top-0 z-40 bg-ardoise text-kraft border-b border-black/20">
  ...
  <a href="{{ url('/') }}" class="flex items-center gap-2.5 font-display font-semibold text-lg shrink-0">
    ...
    <a href="{{ route('inscription') }}" class="font-display text-sm">
...
<main id="contenu" class="min-h-[calc(100vh-4rem)] grid lg:grid-cols-2">
  ...
  <section class="bg-kraft-light paper-grid flex items-center justify-center px-5 sm:px-8 py-14">
    <div class="w-full max-w-md">
      ...
      <form method="POST" action="{{ route('connexion.store') }}" class="space-y-5" novalidate>
        @csrf
        <div>
      ...
      <p class="text-center text-sm">
        ...
        <a href="{{ route('inscription') }}" class="font-display font-semibold text-encre hover:text-encre-dark transition-colors">Rejoindre mon campus</a>
      </p>
    </div>
  </section>
</main>
