...
<header class="sticky top-0 z-40 bg-ardoise text-kraft border-b border-black/20">
  <div class="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
    ...
    <div class="hidden md:flex items-center gap-3 font-display text-sm">
      <a href="{{ route('connexion') }}" class="px-4 py-2 hover:text-moutarde transition-colors">Connexion</a>
      <a href="{{ route('inscription') }}" class="stamp-btn px-4 py-2 rounded-md bg-moutarde text-ardoise font-semibold shadow-md">Créer un compte</a>
    </div>
  ...
  <div id="mobile-menu" class="md:hidden hidden border-t border-kraft/15 bg-ardoise-dark">
    <nav class="flex flex-col px-5 py-3 font-display text-sm" aria-label="Navigation mobile">
      ...
      <a href="{{ route('connexion') }}" class="py-2.5 border-b border-kraft/10">Connexion</a>
      <a href="{{ route('inscription') }}" class="mt-3 text-center px-4 py-2.5 rounded-md bg-moutarde text-ardoise font-semibold">Créer un compte</a>
    </nav>
  </div>
</header>
    ...
    <div class="max-w-6xl mx-auto px-5 sm:px-8 py-16 sm:py-24 grid lg:grid-cols-2 gap-14 items-center">
      ...
      <div>
        ...
        <div class="flex flex-wrap items-center gap-4">
          <a id="inscription" href="{{ route('inscription') }}" class="stamp-btn inline-flex items-center gap-2 px-6 py-3.5 rounded-md bg-moutarde text-ardoise font-display font-semibold shadow-lg">
